...
export function AdminAlertSender() {
	...
	// Format helper for live preview
					...
					{activePreviewTab === 'edit' ? (
						<div className="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-2xs space-y-4">
							...
							<div className="space-y-1">
								...
								<input
									type="text"
									placeholder="e.g. Urgent Notice: Scheduled Maintenance & Update"
									value={subject}
									onChange={(e) => setSubject(e.target.value)}
									className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#E61E32]/20 focus:border-[#E61E32]/40 placeholder:text-slate-400 transition-colors"
								/>
							</div>
							...
							<div className="space-y-1">
								...
								<textarea
									...
									className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-3 text-xs text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#E61E32]/20 focus:border-[#E61E32]/40 placeholder:text-slate-400 transition-colors font-normal resize-y leading-relaxed"
								/>
							</div>
				...
				<div className="space-y-4">
					<div className="bg-white border border-slate-200/90 rounded-2xl p-5 shadow-2xs space-y-4">
							...
							<div className="space-y-3 pt-2 border-t border-slate-100">
								...
								<div className="max-h-60 overflow-y-auto space-y-1.5 pr-1 text-xs">
									{filteredEmployees.length === 0 ? (
										<div className="text-slate-400 py-4 text-center text-xs italic">No active employees match.</div>
									) : (
						...
						<button
							...
							disabled={isSending}
							className="w-full bg-[#E61E32] hover:bg-[#c9182a] disabled:opacity-50 text-white text-xs font-semibold py-2.5 px-4 rounded-xl shadow-xs flex items-center justify-center gap-2 transition-all cursor-pointer"
						>
