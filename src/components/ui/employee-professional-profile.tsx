...
export function EmployeeProfessionalProfileEditor({
	...
	const sx: Sx = {
		...
		input:
			'w-full rounded-xl border border-slate-300 bg-slate-50 px-3.5 py-2.5 text-sm text-slate-800 placeholder:text-slate-400 outline-none focus:border-slate-900 focus:bg-white focus:ring-2 focus:ring-slate-900/10 transition-all',
		title: 'text-base font-semibold text-slate-900',
		muted: 'text-sm text-slate-500',
		btnGhost:
			'inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition-colors',
		...
		tabActive:
			'shrink-0 rounded-lg border border-slate-900 bg-slate-900 px-3.5 py-1.5 text-xs font-semibold text-white whitespace-nowrap shadow-sm',
		...
		<div className="space-y-4">
			...
			<div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-slate-100 bg-white px-5 py-4 shadow-[0_1px_4px_rgba(0,0,0,0.06)]">
				...
				<button
					...
					disabled={saving}
					onClick={() => void save()}
					className="inline-flex items-center gap-1.5 rounded-lg bg-slate-900 px-3 py-1.5 text-xs font-semibold text-white shadow-sm hover:bg-slate-800 disabled:opacity-60 transition-colors"
				>
			...
			<div className="flex justify-end">
				<button
					...
					disabled={saving}
					onClick={() => void save()}
					className="inline-flex items-center gap-2 rounded-xl bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-slate-800 disabled:opacity-60 transition-colors"
				>
