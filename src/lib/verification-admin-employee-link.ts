...
export async function linkAdminToEmployee(admin: {
    ...
    employee: LinkedEmployeePayload | null;
    ...
    const alreadyMerged = roleLower.includes('admin') && (roleLower.includes('technical') || roleLower.includes('tech'));
    const isGenericRole = !roleLower ||
