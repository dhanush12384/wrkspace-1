...
export async function PATCH(req: NextRequest) {
    try {
        ...
        if (body.clear === true) {
            ...
            const upiId = body.upiId != null ? String(body.upiId).trim().slice(0, 120) || null : undefined;
            ...
            const bankIfsc = body.bankIfsc != null
            ...
            if (bankAccountHolderName !== undefined)
                data.bankAccountHolderName = bankAccountHolderName;
